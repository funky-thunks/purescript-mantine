...
import Mantine.Hooks.UIDom (UseClickOutside, HotkeyItem, ResizeRectangle, UseFocusWithin, UseFullscreen, UseFullscreenResult, UseHotkeys, UseHotkeysOptions, UseHover, UseMediaQuery, UseMediaQueryOptions, UseMouse, UseMouseOptions, UseMouseResult, UseMove, UseMoveHandlers, UseMovePosition, UseResizeObserver, UseViewportSize, ViewportDimensions, useClickOutside, useFocusWithin, useFullscreen, useHotkeys, useHover, useMediaQuery, useMouse, useMouse_, useMove, useResizeObserver, useViewportSize)
