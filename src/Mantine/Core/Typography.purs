...
import Mantine.Core.Typography.Table (TableCaptionSide(..), TableProps, table, table_)
import Mantine.Core.Typography.Text (TextProps, TextPropsRow, TextTransform(..), TextTruncate(..), TextVariant(..), WithChildren, text, text_)
