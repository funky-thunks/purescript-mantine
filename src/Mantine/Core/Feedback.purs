...
import Mantine.Core.Feedback.Loader (LoaderProps, LoaderVariant(..), loader, loader_)
import Mantine.Core.Feedback.Notification (NotificationProps, notification, notification_)
import Mantine.Core.Feedback.Progress (ProgressProps, ProgressSection, progress)
