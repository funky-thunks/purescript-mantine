...
import Mantine.Core.Feedback.Loader (LoaderType(..), Props_Loader, Props_LoaderImpl, Props_LoaderInner, Props_LoaderInnerImpl, loader, loader_)
import Mantine.Core.Feedback.Progress (Props_Progress, Props_ProgressImpl, Props_ProgressRoot, Props_ProgressRootImpl, Props_ProgressRootImplRow, Props_ProgressRootRow, Props_ProgressSection, Props_ProgressSectionImpl, Props_ProgressSectionImplRow, Props_ProgressSectionRow, progress, progressLabel_, progressRoot, progressSection)
